        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-10">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground pt-0.5">
              Empowering fitness enthusiasts, elite trainers, and gym owners with next-gen management tools.
            </p>
            <div className="pt-1">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/about" className="text-muted-foreground hover:text-secondary transition-colors">About Us</Link></li>
              <li><Link href="/" className="text-muted-foreground hover:text-secondary transition-colors">Gym Management Software</Link></li>
              <li><Link href="/members" className="text-muted-foreground hover:text-secondary transition-colors">Fitness App (Members)</Link></li>
              <li><Link href="/trainers" className="text-muted-foreground hover:text-secondary transition-colors">Trainers App</Link></li>
            </ul>
          </div>

          {/* Links */}
          <div>
            <h4 className="mb-3 text-xs font-bold uppercase tracking-wider text-foreground">Links</h4>
            <ul className="space-y-2 text-sm">
              <li><Link href="/blog" className="text-muted-foreground hover:text-secondary transition-colors">Blog</Link></li>
              <li><Link href="/disclaimer" className="text-muted-foreground hover:text-secondary transition-colors">Disclaimer</Link></li>
              <li><Link href="/privacy" className="text-muted-foreground hover:text-secondary transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-muted-foreground hover:text-secondary transition-colors">Terms & Conditions</Link></li>
            </ul>
          </div>

          {/* Contacts */}
          <div>
            <h4 className="mb-3 text-xs font-bold uppercase tracking-wider text-foreground">Contacts</h4>
