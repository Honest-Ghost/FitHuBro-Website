  ...
  return (
    <footer className="hairline-t relative pt-16 pb-8 bg-[#0A0A0B]">
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-5 lg:gap-8">
          ...
          <div className="flex flex-col lg:col-span-2 lg:pr-12">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground max-w-sm">
              Empowering fitness enthusiasts, elite trainers, and gym owners with next-generation management tools and a thriving community.
            </p>
            <div className="mt-6">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/" className="text-sm text-muted-foreground hover:text-secondary transition-colors">Gym Management Software</Link></li>
              <li><Link href="/members" className="text-sm text-muted-foreground hover:text-secondary transition-colors">Fitness App (Members)</Link></li>
              <li><Link href="/trainers" className="text-sm text-muted-foreground hover:text-secondary transition-colors">Trainers App</Link></li>
            </ul>
          </div>

          {/* Links */}
          <div>
            <h4 className="mb-6 text-sm font-semibold uppercase tracking-wider text-foreground">Links</h4>
            <ul className="space-y-4">
              <li><Link href="/blog" className="text-sm text-muted-foreground hover:text-secondary transition-colors">Blog</Link></li>
              <li><Link href="/disclaimer" className="text-sm text-muted-foreground hover:text-secondary transition-colors">Disclaimer</Link></li>
              ...
              <li><Link href="/terms" className="text-sm text-muted-foreground hover:text-secondary transition-colors">Terms & Conditions</Link></li>
            </ul>
          </div>

          {/* Contacts */}
          <div>
            <h4 className="mb-6 text-sm font-semibold uppercase tracking-wider text-foreground">Contacts</h4>
            <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
              <p>
                F-A-31, Shaheen Bagh, Okhla,<br />
        ...
        {/* Copyright & Socials Area */}
        <div className="mt-20 flex flex-col items-center justify-between border-t border-white/10 pt-8 pb-4 text-sm text-muted-foreground md:flex-row gap-6">
