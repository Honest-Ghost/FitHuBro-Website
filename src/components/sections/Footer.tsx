          ...
          <div>
            ...
            <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
              <p>
                ...
                South Delhi, Delhi - 110025<br />
              </p>
              <div className="flex flex-col space-y-2">
                <a href="tel:+919911209589" className="hover:text-secondary transition-colors">+ (91) 9911209589</a>
                <a href="mailto:arman.raza987@gmail.com" className="hover:text-secondary transition-colors">arman.raza987@gmail.com</a>
              </div>
            </div>
          </div>
